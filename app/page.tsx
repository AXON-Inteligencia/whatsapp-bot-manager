    ...
    <>
      ...
      <div className={`landing-wrapper ${showSplash ? 'h-screen overflow-hidden' : ''}`}>
        ...
        <div className="nav-inner">
          ...
          <div className="nav-ctas">
            ...
            <a href="https://flow.axoninteligencia.com.br/register" className="btn-primary">Começar Grátis</a>
          </div>
        </div>
      </nav>
        ...
        <div className="hero-inner">
          <div className="hero-content">
            ...
            <div className="hero-ctas">
              <a href="https://flow.axoninteligencia.com.br/register" className="btn-primary" style={{ padding: '14px 28px', fontSize: '15px' }}>Criar conta grátis →</a>
        ...
        <div className="section-inner">
          ...
          <div className="pricing-grid" id="pricing-grid">
            <div className="price-card">
              ...
              <a href="https://flow.axoninteligencia.com.br/register" className="btn-price secondary">Começar Starter</a>
            </div>
            <div className="price-card featured">
              ...
              <a href="https://flow.axoninteligencia.com.br/register" className="btn-price primary-btn">Assinar Plano Pro</a>
            </div>
            <div className="price-card">
              ...
              <a href="https://flow.axoninteligencia.com.br/register" className="btn-price secondary">Começar Enterprise</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="cta-final">
        <div className="cta-final-inner reveal">
          ...
          <a href="https://flow.axoninteligencia.com.br/register" className="btn-cta">Criar minha conta grátis →</a>
